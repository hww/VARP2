...
namespace VARP.Scheme.Tokenizing
{
    ...
    public class Tokenizer
    {
        ...
        private void DefineTokenLocation()
        {
            ...
            location.charNumber = reader.CharNumber;
            location.lineNumber = reader.LineNumber;
            location.colNumber = reader.ColNumber;
            location.file = reader.FilePath;
            lastToken.location = location;
        }
